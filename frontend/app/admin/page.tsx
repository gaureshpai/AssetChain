...
import { LogOut, SquarePlus, List, BarChart3 } from "lucide-react"
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsList className="grid w-full grid-cols-4 bg-slate-700/50 mb-8">
            <TabsTrigger
              value="buildings"
              className="data-[state=active]:bg-amber-600 text-white data-[state=active]:text-black flex items-center gap-2 transition-all duration-200"
            >
